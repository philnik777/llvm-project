...
struct _LIBCPP_TEMPLATE_VIS integral_constant {
  ...
  _LIBCPP_INLINE_VISIBILITY constexpr operator value_type() const noexcept { return value; }
#if _LIBCPP_STD_VER >= 14
  _LIBCPP_INLINE_VISIBILITY constexpr value_type operator()() const noexcept { return value; }
#endif
};

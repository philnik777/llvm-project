...
struct __unwrap_iter_impl {
  static _LIBCPP_HIDE_FROM_ABI constexpr _Iter __rewrap(_Iter, _Iter __iter) { return __iter; }
  static _LIBCPP_HIDE_FROM_ABI constexpr _Iter __unwrap(_Iter __i) noexcept { return __i; }
};
...
struct __unwrap_iter_impl<_Iter, true> {
  ...
  static _LIBCPP_HIDE_FROM_ABI constexpr _Iter __rewrap(_Iter __orig_iter, _ToAddressT __unwrapped_iter) {
    return __orig_iter + (__unwrapped_iter - std::__to_address(__orig_iter));
  }

  static _LIBCPP_HIDE_FROM_ABI constexpr _ToAddressT __unwrap(_Iter __i) noexcept {
...
_LIBCPP_HIDE_FROM_ABI constexpr _OrigIter __rewrap_iter(_OrigIter __orig_iter, _Iter __iter) noexcept {

...
public:
    _LIBCPP_INLINE_VISIBILITY ostream_iterator(ostream_type& __s) noexcept
        : __out_stream_(_VSTD::addressof(__s)), __delim_(nullptr) {}
    _LIBCPP_INLINE_VISIBILITY ostream_iterator(ostream_type& __s, const _CharT* __delimiter) noexcept
